...
# extracting all info in links.parquet and store it as a pandas table
...
for index,url in df['URL'].items():
    ...
    # downloading the images and storing ,  putting try catch to check if link is valid and is the extension there
